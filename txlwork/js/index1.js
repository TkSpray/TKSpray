window.onload = function () {
    ...
    btn.innerHTML = '开始测评';
    p.className = 'text';
    p.innerHTML = '欢迎您参加2018年辅导员工作满意度测评<br><br>测评截止时间为<span class ="ppp">2018年12月24日晚12点</span><br>请及时填写问卷！<br><br>您需要测评的辅导员是' + '<span class="pp">' + '张学友' + '&nbsp&nbsp</span>' + '<br>还需要对&nbsp&nbsp' + '<span class = "pp">' + '张碧晨' + '&nbsp&nbsp</span>' + '继续评测' + '<br><br>每位辅导员有对应的9个测评问题<br>请根据实际情况选择对应选项<br>若中途退出，数据将不予以保存<br>因此请尽量一次填写完问卷，谢谢!';
        ...
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            if (xml.errorCode == 5) {
                ...
                for (var n = 0; n < finished.length; n++) {
                    finished1 += '<span class = "pp">' + finished[n] + '&nbsp&nbsp</span>';
                }
                for (var i = 0; i < unfinished.length; i++) {
                    unfinished1 += '<span class = "pp">' + unfinished[i] + '&nbsp&nbsp</span>';
                }
                btn.innerHTML = '开始评测';
                p.className = 'text';
